...
TOOLS: list[Tool] = [
    ...
    Tool("pen", "Pen", "pen", FREE, "Draw", "P", "Freehand ink", factory=_poly("ink")),
    ...
    Tool("rect", "Rectangle", "rect", DRAG, "Draw", "R", "Rectangle",
         factory=_rect("rect")),
    Tool("ellipse", "Ellipse", "ellipse", DRAG, "Draw", "E", "Ellipse",
         factory=_rect("ellipse")),
    Tool("polygon", "Polygon", "polygon", POLY, "Draw", "",
         "Click each vertex, double-click to close", factory=_poly("polygon")),
    ...
    Tool("callout", "Callout", "callout", DRAG, "Annotate", "",
    ...
    Tool("math", "Calculation", "math", DRAG, "Calculate", "M",
    ...
    Tool("measure_area", "Area", "measure_area", POLY, "Measure", "",
         "Measure an enclosed area", min_points=3, factory=_measure(measure_module.AREA)),
