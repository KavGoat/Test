...
PAGE_GAP = 20
PAPER_MARGIN = 24
CANVAS_COLOUR = QColor("#16161e")
SELECTION_COLOUR = QColor("#7aa2f7")
GROUP_COLOUR = QColor("#bb9af7")
DRAFT_COLOUR = QColor("#f7768e")
CALLOUT_COLOUR = QColor("#ff9e64")
BROKEN_PAGE_COLOUR = QColor("#292e42")
SNAP_COLOUR = QColor("#ff9e64")
MEASURE_COLOUR = QColor("#9ece6a")
